...
post3 = Post.create(title:'Bats Post 1', image: 'https://40.media.tumblr.com/tumblr_lzxmokA0SK1qlllbio1_500.png', description:'Content of Bats post 1', category:'Community', location:'Sheung Wan', longitude:"114.17078018188477", latitude:"22.296402645443738", user_id: user2.id, post_votes: 3)
post4 = Post.create(title:'Bats Post 2', image: 'https://40.media.tumblr.com/tumblr_lzxmokA0SK1qlllbio1_500.png', description:'Content of Bats post 2', category:'Animals', location:'Admiralty', longitude:"22.2864", latitude:"114.153278", user_id: user2.id, post_votes: 4)
post5 = Post.create(title:'Cap Post 1', image: 'http://41.media.tumblr.com/3956a5fb5563f14f6b060dc98c3a2dda/tumblr_nogjowrCWK1t7cmmpo1_1280.png', description:'Content of Caps post 1', category:'Animals', location:'Admiralty', longitude:"114.16820526123047", latitude:"22.27352970576418", user_id: user3.id, post_votes: 5)
post6 = Post.create(title:'Cap Post 2', image: 'http://41.media.tumblr.com/3956a5fb5563f14f6b060dc98c3a2dda/tumblr_nogjowrCWK1t7cmmpo1_1280.png', description:'Content of Caps post 2', category:'Youth', location:'Admiralty', longitude:"114.14588928222656", latitude:"22.253195063470365", user_id: user3.id, post_votes: 6)
post7 = Post.create(title:'Iman Post 1', image: 'https://cdn0.iconfinder.com/data/icons/superhero-2/256/Ironman-128.png', description:'Content of Imans post 1', category:'Environment', location:'Sheung Wan', longitude:"114.17163848876953", latitude:"22.31673100466709", user_id: user4.id, post_votes: 7)
post8 = Post.create(title:'Iman Post 2', image: 'https://cdn0.iconfinder.com/data/icons/superhero-2/256/Ironman-128.png', description:'Content of Imans post 2', category:'Good deeds', location:'Central', longitude:"114.14657592773438", latitude:"22.28337823574864", user_id: user4.id, post_votes: 8)
